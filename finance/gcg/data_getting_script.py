...
#this just makes a super easy to access thing of chances
chance_df.to_csv('data/chancerof500andVXXcompanies.csv')

#big daddy is the big daddy dictionary of all the companies
writer = pd.ExcelWriter('data/worksheet_of_em_all.xlsx', engine = 'xlsxwriter')
